...
public class RewriterTests
{
    ...
    [Test]
    public void can_rewrite_csharp_files_with_namespace_stubs()
    {
...
");
        ...
        CircularReflectionTask.TransformFiles(
            basePaths:"C:\\sourceFiles",
            additionalUsings: "System.Threading;CircularReflection;System.Diagnostics.CodeAnalysis;Microsoft.Build.Framework",
            excludeUsings: "",
            addStubs: true,
            src: files,
            dst: target);
...
namespace Reflection.System.Threading { internal abstract class CircularReferenceStub { } }
namespace Reflection.CircularReflection { internal abstract class CircularReferenceStub { } }
namespace Reflection.System.Diagnostics.CodeAnalysis { internal abstract class CircularReferenceStub { } }
namespace Reflection.Microsoft.Build.Framework { internal abstract class CircularReferenceStub { } }
namespace Reflection.Microsoft.Build.Utilities { internal abstract class CircularReferenceStub { } }
namespace Reflection.Microsoft.CodeAnalysis.CSharp { internal abstract class CircularReferenceStub { } }
namespace Reflection.Namespace.Imported.In.Both.Files { internal abstract class CircularReferenceStub { } }
namespace Reflection.System.Threading.Task { internal abstract class CircularReferenceStub { } }
namespace Reflection.Somewhere.Specific { internal abstract class CircularReferenceStub { } }
"));
    }
    
    [Test]
    public void can_rewrite_csharp_files_without_namespace_stubs()
    {
        var target = new TestFileOutput();
        var files = new TestFileInput();
...
");
        ...
        CircularReflectionTask.TransformFiles(
            basePaths:"C:\\sourceFiles",
            additionalUsings: "System.Threading;CircularReflection;System.Diagnostics.CodeAnalysis;Microsoft.Build.Framework",
            excludeUsings: "Microsoft.CodeAnalysis.CSharp;This.Should.Be.Excluded;",
            addStubs: false,
            src: files,
            dst: target);
